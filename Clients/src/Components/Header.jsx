  ...
  return (
    <header className="bg-[#F8F1E8] border-b border-[#DED8CA]">
      <div className="max-w-7xl mx-auto px-5 py-4">
        ...
        <div className="flex items-center justify-between gap-6">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            <div className="w-9 h-9 rounded-xl bg-[#29483F] flex items-center justify-center">
              <span className="text-[#E8C98D] font-bold text-lg">
                B
              </span>
            </div>
          ...
          {/* Search Bar */}
          <form className="hidden md:flex items-center bg-white border border-[#DDD6C8]
                            rounded-xl px-4 py-2.5 w-64 lg:w-80 xl:w-96
                            shadow-sm focus-within:border-[#29483F] transition">

            <FaSearch
              className="text-[#8A806F] mr-3"
              size={14}
            />
        ...
        {/* Mobile Search */}
        <form className="flex md:hidden items-center bg-white border border-[#DDD6C8]
